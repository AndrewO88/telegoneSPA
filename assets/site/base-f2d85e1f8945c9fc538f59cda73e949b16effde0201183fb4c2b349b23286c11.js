!function (e, t) {
    ...
    function m(e, t) {
        for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++) (r = e[c]).style && (n = r.style.display, t ? ("none" === n && (l[c] = _e.get(r, "display") || null, l[c] || (r.style.display = "")), "" === r.style.display && Fe(r) && (l[c] = (u = a = o = void 0, a = (i = r).ownerDocument, s = i.nodeName, (u = Ue[s]) || (o = a.body.appendChild(a.createElement(s)), u = he.css(o, "display"), o.parentNode.removeChild(o), "none" === u && (u = "block"), Ue[s] = u)))) : "none" !== n && (l[c] = "none", _e.set(r, "display", n)));
    ...
    function b(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === v(o)) he.merge(p, o.nodeType ? [o] : o); else if (Je.test(o)) {
        ...
        for (f.textContent = "", d = 0; o = p[d++];) if (r && -1 < he.inArray(o, r)) i && i.push(o); else if (l = Ie(o), a = y(f.appendChild(o), "script"), l && x(a), n) for (c = 0; o = a[c++];) Ve.test(o.type || "") && n.push(o);
        return f
    }
    ...
    function k(e, i, o) {
        o ? (_e.set(e, i, !1), he.event.add(e, i, {
            namespace: !1, handler: function (e) {
                var t, n, r = _e.get(this, i);
                if (1 & e.isTrigger && this[i]) {
                    if (r.length) (he.event.special[i] || {}).delegateType && e.stopPropagation(); else if (r = ee.call(arguments), _e.set(this, i, r), t = o(this, i), this[i](), r !== (n = _e.get(this, i)) || t ? _e.set(this, i, !1) : n = {}, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n.value
    ...
    function N(n, r, i, o) {
        r = te.apply([], r);
        var e, t, a, s, u, l, c = 0, f = n.length, p = f - 1, d = r[0], h = ce(d);
        ...
        if (f && (t = (e = b(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (s) for (l = a[a.length - 1].ownerDocument, he.map(a, j), c = 0; c < s; c++) u = a[c], Ve.test(u.type || "") && !_e.access(u, "globalEval") && he.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? he._evalUrl && !u.noModule && he._evalUrl(u.src, {nonce: u.nonce || u.getAttribute("nonce")}) : g(u.textContent.replace(it, ""), u, l))
        }
        return n
    }
    ...
    function _(e, t, n) {
        ...
        return (n = n || at(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || Ie(e) || (a = he.style(e, t)), !le.pixelBoxStyles() && ot.test(a) && st.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function R(e, t, n) {
        var r = at(e), i = (!le.boxSizingReliable() || n) && "border-box" === he.css(e, "boxSizing", !1, r), o = i,
            a = _(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
        if (ot.test(a)) {
            if (!n) return a;
            a = "auto"
        }
        return (!le.boxSizingReliable() && i || "auto" === a || !parseFloat(a) && "inline" === he.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === he.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + P(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
    }
    ...
    function B(o, e, t) {
        var n, a, r = 0, i = B.prefilters.length, s = he.Deferred().always(function () {
            delete u.elem
        }), u = function () {
            if (a) return !1;
        ...
        for (function (e, t) {
            var n, r, i, o, a;
            for (n in e) if (i = t[r = p(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = he.cssHooks[r]) && "expand" in a) for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i); else t[r] = i
        }(c, l.opts.specialEasing); r < i; r++) if (n = B.prefilters[r].call(l, o, c, l.opts)) return ce(n.stop) && (he._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n;
        return he.map(c, F, l), ce(l.opts.start) && l.opts.start.call(o, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), he.fx.timer(he.extend(u, {
            elem: o,
            anim: l,
            queue: l.opts.queue
        })), l
    ...
    function G(o) {
        return function (e, t) {
            ...
            var n, r = 0, i = e.toLowerCase().match(ke) || [];
    ...
    he.fn = he.prototype = {
        ...
        var t, n, r, i, o, a, s = e || {}, u = 1, l = arguments.length, c = !1;
        for ("boolean" == typeof s && (c = s, s = arguments[u] || {}, u++), "object" == typeof s || ce(s) || (s = {}), u === l && (s = this, u--); u < l; u++) if (null != (t = arguments[u])) for (n in t) i = t[n], "__proto__" !== n && s !== i && (c && i && (he.isPlainObject(i) || (o = Array.isArray(i))) ? (r = s[n], a = o && !Array.isArray(r) ? [] : o || he.isPlainObject(r) ? r : {}, o = !1, s[n] = he.extend(c, a, i)) : void 0 !== i && (s[n] = i));
        return s
    }, he.extend({
    ...
    var ve = function (n) {
            ...
            if (!r && ((t ? t.ownerDocument || t : $) !== L && N(t), t = t || L, q)) {
                ...
                if (m.qsa && !z[e + " "] && (!O || !O.test(e)) && (1 !== p || "object" !== t.nodeName.toLowerCase())) {
                    if (c = e, f = t, 1 === p && le.test(e)) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(we, Te) : t.setAttribute("id", s = M), o = (l = E(e)).length; o--;) l[o] = "#" + s + " " + h(l[o]);
        ...
        function f(s, e, t) {
            ...
            return e.first ? function (e, t, n) {
                ...
                } else for (; e = e[u];) if (1 === e.nodeType || f) if (i = (o = e[M] || (e[M] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase()) e = e[u] || e; else {
        ...
        function y(d, h, g, v, m, e) {
            return v && !v[M] && (v = y(v)), m && !m[M] && (m = y(m, e)), u(function (e, t, n, r) {
        ...
        function g(e) {
            for (var i, t, n, r = e.length, o = T.relative[e[0].type], a = o || T.relative[" "], s = o ? 1 : 0, u = f(function (e) {
                ...
                return i = null, r
            }]; s < r; s++) if (t = T.relative[e[s].type]) c = [f(p(c), t)]; else {
        ...
        var v, m, T, x, C, E, k, D, S, j, A, N, L, _, q, O, H, P, R, M = "sizzle" + 1 * new Date, $ = n.document, I = 0,
            W = 0, F = e(), B = e(), U = e(), z = e(), X = function (e, t) {
                return e === t && (A = !0), 0
        ...
        for (v in m = b.support = {}, C = b.isXML = function (e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement && (_ = (L = r).documentElement, q = !C(L), $ !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), m.attributes = i(function (e) {
            ...
            }, H = [], O = [], (m.qsa = ve.test(L.querySelectorAll)) && (i(function (e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && O.push("name" + te + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && O.push(":enabled", ":disabled"), _.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && O.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), O.push(",.*:")
            })), (m.matchesSelector = ve.test(P = _.matches || _.webkitMatchesSelector || _.mozMatchesSelector || _.oMatchesSelector || _.msMatchesSelector)) && i(function (e) {
                m.disconnectedMatch = P.call(e, "*"), P.call(e, "[s!='']:x"), H.push("!=", ie)
            }), O = O.length && new RegExp(O.join("|")), H = H.length && new RegExp(H.join("|")), t = ve.test(_.compareDocumentPosition), R = t || ve.test(_.contains) ? function (e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !m.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === $ && R($, e) ? -1 : t === L || t.ownerDocument === $ && R($, t) ? 1 : j ? Z(j, e) - Z(j, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return A = !0, 0;
            ...
            if ((e.ownerDocument || e) !== L && N(e), m.matchesSelector && q && !z[t + " "] && (!H || !H.test(t)) && (!O || !O.test(t))) try {
                var n = P.call(e, t);
                    ...
                    return 1 === g && 0 === v ? function (e) {
                        ...
                        if (c) {
                            ...
                            if (u = [y ? c.firstChild : c.lastChild], y && p) {
                                for (d = (s = (r = (i = (o = (a = c)[M] || (a[M] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === I && r[1]) && r[2], a = s && c.childNodes[s]; a = ++s && a && a[l] || (d = s = 0) || u.pop();) if (1 === a.nodeType && ++d && a === e) {
                                    i[h] = [I, s, d];
                                    break
                                }
                            } else if (p && (d = s = (r = (i = (o = (a = e)[M] || (a[M] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === I && r[1]), !1 === d) for (; (a = ++s && a && a[l] || (d = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++d || (p && ((i = (o = a[M] || (a[M] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [I, d]), a !== e));) ;
                            return (d -= v) === g || d % g == 0 && 0 <= d / g
                        }
                    }
                }, PSEUDO: function (e, o) {
                    var t, a = T.pseudos[e] || T.setFilters[e.toLowerCase()] || b.error("unsupported pseudo: " + e);
                    return a[M] ? a(o) : 1 < a.length ? (t = [e, e, "", o], T.setFilters.hasOwnProperty(e.toLowerCase()) ? u(function (e, t) {
            ...
            pseudos: {
                not: u(function (e) {
                    var r = [], i = [], s = k(e.replace(ae, "$1"));
                    return s[M] ? u(function (e, t, n, r) {
        ...
        return c.prototype = T.filters = T.pseudos, T.setFilters = new c, E = b.tokenize = function (e, t) {
            var n, r, i, o, a, s, u, l = B[e + " "];
            if (l) return t ? 0 : l.slice(0);
            for (a = e, s = [], u = T.preFilter; a;) {
                for (o in n && !(r = se.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])), n = !1, (r = ue.exec(a)) && (n = r.shift(), i.push({
                    value: n,
                    type: r[0].replace(ae, " ")
            ...
            var n, v, m, y, x, r, i = [], o = [], a = U[e + " "];
            if (!a) {
                for (t || (t = E(e)), n = t.length; n--;) (a = g(t[n]))[M] ? i.push(a) : o.push(a);
                (a = U(e, (v = o, y = 0 < (m = i).length, x = 0 < v.length, r = function (e, t, n, r, i) {
                    var o, a, s, u = 0, l = "0", c = e && [], f = [], p = S, d = e || x && T.find.TAG("*", i),
                        h = I += null == p ? 1 : Math.random() || .1, g = d.length;
                    for (i && (S = t === L || t || i); l !== g && null != (o = d[l]); l++) {
                        if (x && o) {
                            for (a = 0, t || o.ownerDocument === L || (N(o), n = !q); s = v[a++];) if (s(o, t || L, n)) {
                                r.push(o);
                                break
                            }
                            i && (I = h)
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (i = pe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !T.relative[s = a.type]);) if ((u = T.find[s]) && (r = u(a.matches[0].replace(xe, be), ye.test(o[0].type) && d(t.parentNode) || t))) {
                    if (o.splice(i, 1), !(e = r.length && h(o))) return J.apply(n, r), n;
                    break
                }
            }
            return (l || k(e, c))(r, t, !q, n, !t || ye.test(e) && d(t.parentNode) || t), n
        }, m.sortStable = M.split("").sort(X
        ).join("") === M, m.detectDuplicates = !!A, N(), m.sortDetached = i(function (e) {
    ...
    he.fn.extend({
        ...
        he.fn[r] = function (e, t) {
            ...
            return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = he.filter(t, n)), 1 < this.length && (Ee[r] || he.uniqueSort(n), Ce.test(r) && n.reverse()), this.pushStack(n)
        }
    });
    var ke = /[^\x20\t\r\n\f]+/g;
    he.Callbacks = function (r) {
        var e, n;
        r = "string" == typeof r ? (e = r, n = {}, he.each(e.match(ke) || [], function (e, t) {
            n[t] = !0
        }), n) : he.extend({}, r);
        ...
        Deferred: function (e) {
                            ...
                            return function () {
                                var n = this, r = arguments, e = function () {
                                    ...
                                    if (!(i < l)) {
                                        ...
                                        t = e && ("object" == typeof e || "function" == typeof e) && e.then, ce(t) ? s ? t.call(e, u(l, o, c, s), u(l, o, f, s)) : (l++, t.call(e, u(l, o, c, s), u(l, o, f, s), u(l, o, c, o.notifyWith))) : (a !== c && (n = void 0, r = [e]), (s || o.resolveWith)(n, r))
                                    }
                                }, t = s ? e : function () {
                                    try {
                                        e()
            ...
            var n = arguments.length, t = n, r = Array(t), i = ee.call(arguments), o = he.Deferred(), a = function (t) {
                return function (e) {
    ...
    }), he.ready.then = Se.then, "complete" === K.readyState || "loading" !== K.readyState && !K.documentElement.doScroll ? C.setTimeout(he.ready) : (K.addEventListener("DOMContentLoaded", r), C.addEventListener("load", r));
    var je = function (e, t, n, r, i, o, a) {
        var s = 0, u = e.length, l = null == n;
        if ("object" === v(n)) for (s in i = !0, n) je(e, t, s, n[s], !0, o, a); else if (void 0 !== r && (i = !0, ce(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function (e, t, n) {
            return l.call(he(e), n)
        })), t)) for (; s < u; s++) t(e[s], n, a ? r : r.call(e[s], s, t(e[s], n)));
        return i ? e : l ? t.call(e) : u ? t(e[0], n) : o
    }, Ae = /^-ms-/, Ne = /-([a-z])/g, Le = function (e) {
    ...
    o.uid = 1, o.prototype = {
        cache: function (e) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(p) : (t = p(t)) in r ? [t] : t.match(ke) || []).length;
                    for (; n--;) delete r[t[n]]
                }
    ...
    var _e = new o, qe = new o, Oe = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, He = /[A-Z]/g;
    he.extend({
        hasData: function (e) {
    ...
    var Pe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Re = new RegExp("^(?:([+-])=|)(" + Pe + ")([a-z%]*)$", "i"),
        Me = ["Top", "Right", "Bottom", "Left"], $e = K.documentElement, Ie = function (e) {
            return he.contains(e.ownerDocument, e)
        }, We = {composed: !0};
    $e.getRootNode && (Ie = function (e) {
    ...
    he.event = {
        global: {}, add: function (t, e, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, v = _e.get(t);
            if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && he.find.matchesSelector($e, i), n.guid || (n.guid = he.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (e) {
                return void 0 !== he && he.event.triggered !== e.type ? he.event.dispatch.apply(t, arguments) : void 0
            }), l = (e = (e || "").match(ke) || [""]).length; l--;) d = g = (s = et.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = he.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = he.event.special[d] || {}, c = he.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
                ...
                namespace: h.join(".")
            }, o), (p = u[d]) || ((p = u[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(t, r, h, a) || t.addEventListener && t.addEventListener(d, a)), f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), he.event.global[d] = !0)
        }, remove: function (e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, v = _e.hasData(e) && _e.get(e);
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(ke) || [""]).length; l--;) if (d = g = (s = et.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
            ...
            var t, n, r, i, o, a, s = he.event.fix(e), u = new Array(arguments.length),
                l = (_e.get(this, "events") || {})[s.type] || [], c = he.event.special[s.type] || {};
            ...
            load: {noBubble: !0}, click: {
                setup: function (e) {
                    var t = this || e;
                    return ze.test(t.type) && t.click && l(t, "input") && k(t, "click", a), !1
                }, trigger: function (e) {
                    var t = this || e;
                    return ze.test(t.type) && t.click && l(t, "input") && k(t, "click"), !0
                }, _default: function (e) {
                    var t = e.target;
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? a : w, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && he.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[he.expando] = !0
    }, he.Event.prototype = {
    ...
    he.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(le.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || he.isXMLDoc(e))) for (a = y(c), r = 0, i = (o = y(e)).length; r < i; r++) s = o[r], "input" === (l = (u = a[r]).nodeName.toLowerCase()) && ze.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
            if (t) if (n) for (o = o || y(e), a = a || y(c), r = 0, i = o.length; r < i; r++) A(o[r], a[r]); else A(e, c);
    ...
    var ot = new RegExp("^(" + Pe + ")(?!px)[a-z%]+$", "i"), at = function (e) {
    ...
    !function () {
        function e() {
            if (u) {
                s.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", u.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", $e.appendChild(s).appendChild(u);
                var e = C.getComputedStyle(u);
                n = "1%" !== e.top, a = 12 === t(e.marginLeft), u.style.right = "60%", o = 36 === t(e.right), r = 36 === t(e.width), u.style.position = "absolute", i = 12 === t(u.offsetWidth / 3), $e.removeChild(s), u = null
            }
        }
    ...
    he.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = p(t), u = pt.test(t), l = e.style;
                if (u || (t = O(s)), a = he.cssHooks[t] || he.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                "string" == (o = typeof n) && (i = Re.exec(n)) && i[1] && (n = h(e, t, i), o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (he.cssNumber[s] ? "" : "px")), le.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = p(t);
            return pt.test(t) || (t = O(s)), (a = he.cssHooks[t] || he.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = _(e, t, r)), "normal" === i && t in ht && (i = ht[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), he.each(["height", "width"], function (e, u) {
        he.cssHooks[u] = {
            get: function (e, t, n) {
                if (t) return !ft.test(he.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? R(e, u, n) : Be(e, dt, function () {
                    return R(e, u, n)
                })
            }, set: function (e, t, n) {
                var r, i = at(e), o = !le.scrollboxSize() && "absolute" === i.position,
                    a = (o || n) && "border-box" === he.css(e, "boxSizing", !1, i), s = n ? P(e, u, n, a, i) : 0;
                return a && o && (s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - P(e, u, "border", !1, i) - .5)), s && (r = Re.exec(t)) && "px" !== (r[3] || "px") && (e.style[u] = t, t = he.css(e, u)), H(0, t, s)
            }
        }
    }), he.cssHooks.marginLeft = q(le.reliableMarginLeft, function (e, t) {
        if (t) return (parseFloat(_(e, "marginLeft")) || e.getBoundingClientRect().left - Be(e, {marginLeft: 0}, function () {
    ...
    he.Animation = he.extend(B, {
        tweeners: {
            ...
            var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style,
                g = e.nodeType && Fe(e), v = _e.get(e, "fxshow");
            ...
            if ((u = !he.isEmptyObject(t)) || !he.isEmptyObject(d)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = _e.get(e, "display")), "none" === (c = he.css(e, "display")) && (l ? c = l : (m([e], !0), l = e.style.display || l, c = he.css(e, "display"), m([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === he.css(e, "float") && (u || (p.done(function () {
                h.display = l
            }), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), u = !1, d) u || (v ? "hidden" in v && (g = v.hidden) : v = _e.access(e, "fxshow", {display: l}), o && (v.hidden = !g), g && m([e], !0), p.done(function () {
                for (r in g || m([e]), _e.remove(e, "fxshow"), d) he.style(e, r, d[r])
            })), u = F(g ? v[r] : 0, r, p), r in v || (v[r] = u.start, g && (u.end = u.start, u.start = 0))
        ...
        fadeTo: function (e, t, n, r) {
            ...
            var i = he.isEmptyObject(t), o = he.speed(e, n, r), a = function () {
                var e = B(this, he.extend({}, t), o);
            ...
            return "string" != typeof i && (o = e, e = i, i = void 0), e && !1 !== i && this.queue(i || "fx", []), this.each(function () {
                var e = !0, t = null != i && i + "queueHooks", n = he.timers, r = _e.get(this);
                if (t) r[t] && r[t].stop && a(r[t]); else for (t in r) r[t] && r[t].stop && bt.test(t) && a(r[t]);
                for (t = n.length; t--;) n[t].elem !== this || null != i && n[t].queue !== i || (n[t].anim.stop(o), e = !1, n.splice(t, 1));
                !e && o || he.dequeue(this, i)
            })
        }, finish: function (a) {
            return !1 !== a && (a = a || "fx"), this.each(function () {
                var e, t = _e.get(this), n = t[a + "queue"], r = t[a + "queueHooks"], i = he.timers,
                    o = n ? n.length : 0;
    ...
    }, mt = K.createElement("input"), yt = K.createElement("select").appendChild(K.createElement("option")), mt.type = "checkbox", le.checkOn = "" !== mt.value,
        le.optSelected = yt.selected, (mt = K.createElement("input")).value = "t", mt.type = "radio", le.radioValue = "t" === mt.value;
    ...
    he.fn.extend({
        ...
        addClass: function (t) {
            ...
            if ((e = X(t)).length) for (; n = this[u++];) if (i = z(n), r = 1 === n.nodeType && " " + U(i) + " ") {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : ce(i) ? this.each(function (e) {
                he(this).toggleClass(i.call(this, e, z(this), t), t)
            }) : this.each(function () {
                var e, t, n, r;
                if (a) for (t = 0, n = he(this), r = X(i); e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else void 0 !== i && "boolean" !== o || ((e = z(this)) && _e.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === i ? "" : _e.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
    ...
    he.fn.extend({
        val: function (n) {
            ...
            })) : t ? (r = he.valHooks[t.type] || he.valHooks[t.nodeName.toLowerCase()]) && "get" in r && void 0 !== (e = r.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(kt, "") : null == e ? "" : e : void 0
        }
    }), he.extend({
        valHooks: {
            option: {
    ...
    var Dt = /^(?:focusinfocus|focusoutblur)$/, St = function (e) {
        e.stopPropagation()
    };
    he.extend(he.event, {
        trigger: function (e, t, n, r) {
            var i, o, a, s, u, l, c, f, p = [n || K], d = ae.call(e, "type") ? e.type : e,
                h = ae.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = f = a = n = n || K, 3 !== n.nodeType && 8 !== n.nodeType && !Dt.test(d + he.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (e = e[he.expando] ? e : new he.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : he.makeArray(t, [e]), c = he.event.special[d] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !fe(n)) {
                    for (s = c.delegateType || d, Dt.test(s + d) || (o = o.parentNode); o; o = o.parentNode) p.push(o), a = o;
                    a === (n.ownerDocument || K) && p.push(a.defaultView || a.parentWindow || C)
                }
                for (i = 0; (o = p[i++]) && !e.isPropagationStopped();) f = o, e.type = 1 < i ? s : c.bindType || d, (l = (_e.get(o, "events") || {})[e.type] && _e.get(o, "handle")) && l.apply(o, t), (l = u && o[u]) && l.apply && Le(o) && (e.result = l.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = d, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(p.pop(), t) || !Le(n) || u && ce(n[d]) && !fe(n) && ((a = n[u]) && (n[u] = null), he.event.triggered = d, e.isPropagationStopped() && f.addEventListener(d, St), n[d](), e.isPropagationStopped() && f.removeEventListener(d, St), he.event.triggered = void 0, a && (n[u] = a)), e.result
            }
        ...
        he.event.special[r] = {
            setup: function () {
                var e = this.ownerDocument || this, t = _e.access(e, r);
                t || e.addEventListener(n, i, !0), _e.access(e, r, (t || 0) + 1)
            }, teardown: function () {
                var e = this.ownerDocument || this, t = _e.access(e, r) - 1;
                t ? _e.access(e, r, t) : (e.removeEventListener(n, i, !0), _e.remove(e, r))
            }
        }
    });
    var jt = C.location, At = Date.now(), Nt = /\?/;
    ...
    var Ht = /%20/g, Pt = /#.*$/, Rt = /([?&])_=[^&]*/, Mt = /^(.*?):[ \t]*([^\r\n]*)$/gm, $t = /^(?:GET|HEAD)$/,
        It = /^\/\//, Wt = {}, Ft = {}, Bt = "*/".concat("*"), Ut = K.createElement("a");
    Ut.href = jt.href, he.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            function n(e, t, n, r) {
                ...
                }(v, s, T, i), i ? (v.ifModified && ((u = T.getResponseHeader("Last-Modified")) && (he.lastModified[f] = u), (u = T.getResponseHeader("etag")) && (he.etag[f] = u)), 204 === e || "HEAD" === v.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = s.state, o = s.data, i = !(a = s.error))) : (a = l, !e && l || (l = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || l) + "", i ? x.resolveWith(m, [o, l, T]) : x.rejectWith(m, [T, l, a]), T.statusCode(w), w = void 0, g && y.trigger(i ? "ajaxSuccess" : "ajaxError", [T, v, i ? o : a]), b.fireWith(m, [T, l]), g && (y.trigger("ajaxComplete", [T, v]), --he.active || he.event.trigger("ajaxStop")))
            }

            "object" == typeof e && (t = e, e = void 0), t = t || {};
            var c, f, p, r, d, i, h, g, o, a, v = he.ajaxSetup({}, t), m = v.context || v,
                y = v.context && (m.nodeType || m.jquery) ? he(m) : he.event, x = he.Deferred(),
                b = he.Callbacks("once memory"), w = v.statusCode || {}, s = {}, u = {}, l = "canceled", T = {
            ...
            if (x.promise(T), v.url = ((e || v.url || jt.href) + "").replace(It, jt.protocol + "//"), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || "*").toLowerCase().match(ke) || [""], null == v.crossDomain) {
                i = K.createElement("a");
                try {
            ...
            for (o in (g = he.event && v.global) && 0 == he.active++ && he.event.trigger("ajaxStart"), v.type = v.type.toUpperCase(), v.hasContent = !$t.test(v.type), f = v.url.replace(Pt, ""), v.hasContent ? v.data && v.processData && 0 === (v.contentType || "").indexOf("application/x-www-form-urlencoded") && (v.data = v.data.replace(Ht, "+")) : (a = v.url.slice(f.length), v.data && (v.processData || "string" == typeof v.data) && (f += (Nt.test(f) ? "&" : "?") + v.data, delete v.data), !1 === v.cache && (f = f.replace(Rt, "$1"), a = (Nt.test(f) ? "&" : "?") + "_=" + At++ + a), v.url = f + a), v.ifModified && (he.lastModified[f] && T.setRequestHeader("If-Modified-Since", he.lastModified[f]), he.etag[f] && T.setRequestHeader("If-None-Match", he.etag[f])), (v.data && v.hasContent && !1 !== v.contentType || t.contentType) && T.setRequestHeader("Content-Type", v.contentType), T.setRequestHeader("Accept", v.dataTypes[0] && v.accepts[v.dataTypes[0]] ? v.accepts[v.dataTypes[0]] + ("*" !== v.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : v.accepts["*"]), v.headers) T.setRequestHeader(o, v.headers[o]);
            if (v.beforeSend && (!1 === v.beforeSend.call(m, T, v) || h)) return T.abort();
            if (l = "abort", b.add(v.complete), T.done(v.success), T.fail(v.error), c = Y(Ft, v, t, T)) {
    ...
    var zt = {0: 200, 1223: 204}, Xt = he.ajaxSettings.xhr();
    ...
    he.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = ce(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Yt, "$1" + r) : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
        ...
        return -1 < s && (r = U(e.slice(s)), e = e.slice(0, s)), ce(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 0 < a.length && he.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
        ...
        he.each({padding: "inner" + a, content: s, "": "outer" + a}, function (r, o) {
            he.fn[o] = function (e, t) {
                ...
                return je(this, function (e, t, n) {
                    var r;
                    return fe(e) ? 0 === o.indexOf("outer") ? e["inner" + a] : e.document.documentElement["client" + a] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + a], r["scroll" + a], e.body["offset" + a], r["offset" + a], r["client" + a])) : void 0 === n ? he.css(e, t, i) : he.style(e, t, n, i)
                }, s, n ? e : void 0, n)
            }
        })
    ...
    return n = [function (e, t, n) {
        ...
        function o(t) {
            return v(this, void 0, void 0, function () {
                ...
                return m(this, function () {
                    if (b && !t.getData(T) && w("clipboard.write() was called without a `text/plain` data type. On some platforms, this may result in an empty clipboard. Call clipboard.suppressWarnings() to suppress this warning."), g()) {
                        if (function () {
                            var e = t.getData(T);
                    ...
                    }(t)) return x("copyUsingTempElem worked"), [2];
                    if (void 0 !== (e = t.getData(T)) && function (e) {
                        x("copyTextUsingDOM");
                        var t = document.createElement("div");
                    ...
                    }(e)) return x("copyTextUsingDOM worked"), [2];
        ...
        function u() {
            return v(this, void 0, void 0, function () {
                return m(this, function () {
                    ...
                    if (g()) return x("Reading text using IE strategy."), [2, function () {
                        return v(this, void 0, void 0, function () {
                            var e;
                            return m(this, function () {
        ...
        function l() {
            C || (b && w('The deprecated default object of `clipboard-polyfill` was called. Please switch to `import * as clipboard from "clipboard-polyfill"` and see https://github.com/lgarron/clipboard-polyfill/issues/101 for more info.'), C = !0)
        }

        function c(e) {
            var t = new k, n = function (r, e, i) {
                x("listener called"), r.success = !0, e.forEach(function (e, t) {
        ...
        var v = this && this.__awaiter || function (t, a, s, u) {
        ...
        }.bind("[clipboard-polyfill]"), T = "text/plain";
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var n = ["text/plain", "text/html"], r = function () {
    ...
    function e() {
        $(".form-nav__link").on("click touch", function () {
            var e = $(this).index();
            $(".form-nav__link_active").removeClass("form-nav__link_active"), $(this).addClass("form-nav__link_active"), $(".form-box__item_active").removeClass("form-box__item_active"), $(".form-box__item").eq(e).addClass("form-box__item_active")
    ...
    function t() {
        $(".free__button").on("click touch", function () {
            var e = $(".free__input").val(), t = "";
            "" != e && (t = "https://teleg-on.online/" + (e = (e = (e = (e = (e = e.replace("t.me/", "")).replace("http://", "")).replace("https://", "")).replace("teleg-on.online/", "")).replace("@", "")), $(".free__input").val(t), $(".free__button").text("\u0421\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u043d\u043e!"), clipboard.writeText(t), setTimeout(function () {
